 ...
 * SPDX-FileCopyrightText: 2025 MoveCall (GC9D01 Adaptation)
 *
...
#define ESP_LCD_Gc9D01_VER_MAJOR    '0'
#define ESP_LCD_Gc9D01_VER_MINOR    '1'
#define ESP_LCD_Gc9D01_VER_PATCH    '0'
