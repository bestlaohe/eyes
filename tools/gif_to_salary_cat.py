...
def convert_gif(
    ...
    *,
    ...
    print(
        ...
        f"{len(frames)} frames {width}x{height}, {total_kb} KB"
    )
    return 0
...
def main() -> int:
    ...
    width = args.width if args.width is not None else 100
    height = args.height if args.height is not None else 100
    step = args.step if args.step is not None else 4
